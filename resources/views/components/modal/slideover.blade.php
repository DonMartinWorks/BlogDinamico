<!-- Panel SlideOver -->
<div x-data="{ open: @entangle('openSlideOver').defer }" @keydown.window.escape="open = false" x-show="open" class="relative z-10"
                ...
                <div x-show="open" x-transition:enter="transform transition ease-in-out duration-500 sm:duration-700"
                    ...
                    <div class="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                        <div class="px-4 sm:px-6">
                            <h2 class="text-lg font-medium text-gray-900" id="slide-over-title">{{ __('Dashboard') }}
                            </h2>
                        </div>
