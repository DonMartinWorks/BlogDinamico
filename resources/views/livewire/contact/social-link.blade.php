<div class="flex justify-center mt-8 space-x-6">
    @forelse($socialLinks as $socialLink)
        <a href="{{ $socialLink->url }}" target="_blank" title="{{ $socialLink->name }}" class="text-4xl text-gray-300 hover:text-sky-500">
    ...
    <div class="flex items-center space-x-2">
        ...
        <x-actions.action wire:click.prevent="openSlide" title="{{ __('Edit') }}" class="text-yellow-300 hover:text-purple-400">
            <x-icons.pencil />
        </x-actions.action>
    </div>
